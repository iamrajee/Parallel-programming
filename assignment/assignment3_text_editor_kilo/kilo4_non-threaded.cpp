...
clock_t Without_Thread_time = clock(); //starting clock
using namespace std;
    ...
    switch (c) {
        ...
        case CTRL_KEY('q'):
            if (E.dirty && quit_times > 0) {
                ...
                cout << "\033[1;4;30m" << "\n\n \033[1;4;32m "<<"************* Without_Thread_time = "<<(double)(Without_Thread_time)/CLOCKS_PER_SEC << " Sec, "<<" TOTAL_CPU TME = "<<(double)(clock() - tStart)/CLOCKS_PER_SEC << " Sec *********"<<"\033[0m ";
                return;
            }
            write(STDOUT_FILENO, "\x1b[2J", 4);
            write(STDOUT_FILENO, "\x1b[H", 3);
...
/****************************************** SIMPLY WITHOUT THREAD ***********************************************/
    Without_Thread_time = clock();
    ...
    Without_Thread_time = clock() - Without_Thread_time;
/***************************************************************************************************************/
